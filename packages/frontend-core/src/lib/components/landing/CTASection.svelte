    ...
    <div class="cta-inner reveal" class:is-visible={visible}>
      ...
      <div class="cta-content">
        ...
        <div class="cta-actions">
          <a href={routes.workspace} class="btn-accent cta-btn">
            Open workspace
            <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
              <path d="M3 8h10M9 4l4 4-4 4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </a>
          <a href={routes.gettingStarted} class="btn-secondary cta-btn">
            See the guide
          </a>
        </div>
      ...
      <div class="cta-receive">
        <div class="receive-card">
          ...
          <a href={routes.receive} class="btn-secondary receive-btn">Enter room code →</a>
        </div>
      </div>
